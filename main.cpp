...
Поочередно к каждой из частей добавляется вершина, для которой наибольшим является количество ребер, соединяющих ее с вершинами, уже набранными в эту часть.
